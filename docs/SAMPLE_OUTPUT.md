...
*Produced by `nvidia/nemotron-3-super-120b-a12b` at temperature 0.2, commit `d37a6c6`.
Model output: the wording varies between runs, the facts do not.*
...
*Produced by `nvidia/nemotron-3-super-120b-a12b` at temperature 0.3, commit `d37a6c6`.*
